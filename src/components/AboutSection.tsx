  ...
  const highlights = [
    {
      ...
      description: "Especialista em React.js, React Native e TypeScript para aplicações modernas"
    },
    {
      icon: Zap,
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-slide-up">
            <h3 className="text-2xl font-semibold mb-6 text-foreground">
              <h3 className="text-2xl font-semibold mb-6 text-foreground">
                Especialista em React.js, React Native e JavaScript
              </h3>
            </h3>
            <div className="space-y-4 text-muted-foreground">
              ...
              <p>
                Tenho experiência em consumo de APIs, integração com Firebase e bancos de dados, 
                além de interfaces responsivas e intuitivas. Meus projetos vão desde a concepção 
                até o deploy em plataformas como Vercel, Netlify e Firebase Hosting.
              </p>
